...
def train(nepochs, batch_size, noise_size, checkpoint):
    ...
    with tf.variable_scope('D') as scope:
        ...
        D_real_logits, D_real = dcgan_discriminator_mnist(data_ph, y=cond_D_ph, prob=dropout_prob_ph)
    with tf.variable_scope('D', reuse=True):
        D_fake_logits, D_fake = dcgan_discriminator_mnist(G_sample, y=cond_G_ph, prob=dropout_prob_ph)
